...
-keep class com.jyotirmoy.musicly.data.service.cast.CastOptionsProvider { *; }
...
-keep class com.jyotirmoy.musicly.data.preferences.PreferenceBackupEntry { *; }
-keep class com.jyotirmoy.musicly.data.backup.model.** { *; }
-keep class com.jyotirmoy.musicly.data.backup.module.** { *; }
