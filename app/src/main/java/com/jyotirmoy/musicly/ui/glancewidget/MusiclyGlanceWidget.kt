...
import com.jyotirmoy.musicly.data.model.PlayerInfo
import com.jyotirmoy.musicly.R
import androidx.core.graphics.scale
import androidx.glance.unit.ColorProvider
import com.jyotirmoy.musicly.data.model.QueueItem
import com.jyotirmoy.musicly.utils.createScalableBackgroundBitmap
import timber.log.Timber

class MusiclyGlanceWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            Timber.tag("MusiclyGlanceWidget")
    ...
    private fun WidgetUi(
        ...
        val title = playerInfo.songTitle.ifEmpty { "Musicly" }
    ...
    fun ExtraLargeWidgetLayout(
        ...
        Box(
            ...
            Column(modifier = GlanceModifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Spacer(GlanceModifier.defaultWeight()) // Pushes content down
