...
fun PlayingEqIcon(
    ...
    phaseDurationMillis: Int = 2400,   // slowest cycle
    wanderDurationMillis: Int = 8000,  // longest pattern
    ...
    // INTEGER speeds -> perfect continuity in wrap 2π
    ...
    Canvas(modifier = modifier) {
        ...
        repeat(bars) { i ->
            ...
            // Morph: dot <-> bar (regardless of frame)
