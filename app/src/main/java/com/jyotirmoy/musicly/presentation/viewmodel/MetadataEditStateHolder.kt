...
import com.jyotirmoy.musicly.data.media.ImageCacheManager
import com.jyotirmoy.musicly.data.media.MetadataEditError
...
import com.jyotirmoy.musicly.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.jyotirmoy.musicly.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
