...
import com.jyotirmoy.musicly.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.jyotirmoy.musicly.presentation.viewmodel.StablePlayerState>
    ) {
