...
import com.jyotirmoy.musicly.data.model.SortOption // Added import
...
import com.jyotirmoy.musicly.data.equalizer.EqualizerPreset // Added import
        ...
        dataStore.edit { preferences ->
            ...
            if (orderJson != null) {
                try {
                    ...
                    // If deserialization fails, do nothing to avoid overwriting user data.
                }
            }
            // If orderJson is null, it means the user has never reordered,
            // so the default order which already includes FOLDERS will be used.
        }
    }
