package com.jyotirmoy.musicly.data.backup

import android.content.Context
import android.net.Uri
import android.os.Build
import com.jyotirmoy.musicly.data.backup.format.BackupReader
import com.jyotirmoy.musicly.data.backup.format.BackupWriter
import com.jyotirmoy.musicly.data.backup.history.BackupHistoryRepository
import com.jyotirmoy.musicly.data.backup.model.BackupHistoryEntry
import com.jyotirmoy.musicly.data.backup.model.BackupManifest
...
import com.jyotirmoy.musicly.data.backup.model.BackupValidationResult
import com.jyotirmoy.musicly.data.backup.model.DeviceInfo
import com.jyotirmoy.musicly.data.backup.model.RestorePlan
import com.jyotirmoy.musicly.data.backup.model.RestoreResult
import com.jyotirmoy.musicly.data.backup.module.BackupModuleHandler
import com.jyotirmoy.musicly.data.backup.restore.RestoreExecutor
import com.jyotirmoy.musicly.data.backup.restore.RestorePlanner
import com.jyotirmoy.musicly.data.backup.validation.ValidationPipeline
...
class BackupManager @Inject constructor(
    ...
    suspend fun export(
        ...
        runCatching {
            ...
            reportProgress(onProgress, BackupOperationType.EXPORT, ++step, totalSteps,
                "Backup complete", "Your Musicly backup was created successfully.")
        }
    }
