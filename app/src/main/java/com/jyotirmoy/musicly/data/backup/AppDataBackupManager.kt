...
import com.jyotirmoy.musicly.data.database.FavoritesEntity
import com.jyotirmoy.musicly.data.database.LyricsDao
import com.jyotirmoy.musicly.data.database.LyricsEntity
...
import com.jyotirmoy.musicly.data.database.SongEngagementEntity
import com.jyotirmoy.musicly.data.database.TransitionDao
import com.jyotirmoy.musicly.data.database.TransitionRuleEntity
import com.jyotirmoy.musicly.data.preferences.PreferenceBackupEntry
import com.jyotirmoy.musicly.data.preferences.UserPreferencesRepository
import com.jyotirmoy.musicly.data.stats.PlaybackStatsRepository
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Musicly backup was created successfully."
            )
        }
    }
