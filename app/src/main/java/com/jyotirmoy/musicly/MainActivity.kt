...
import com.jyotirmoy.musicly.presentation.components.UnifiedPlayerSheet
import com.jyotirmoy.musicly.presentation.components.UnifiedPlayerSheetV2
import com.jyotirmoy.musicly.presentation.navigation.AppNavigation
import com.jyotirmoy.musicly.presentation.navigation.Screen
import com.jyotirmoy.musicly.presentation.screens.SetupScreen
import com.jyotirmoy.musicly.presentation.viewmodel.MainViewModel
import com.jyotirmoy.musicly.presentation.viewmodel.PlayerViewModel
import com.jyotirmoy.musicly.ui.theme.MusiclyTheme
import com.jyotirmoy.musicly.utils.CrashHandler
import com.jyotirmoy.musicly.utils.LogUtils
import com.jyotirmoy.musicly.presentation.components.CrashReportDialog
...
import com.jyotirmoy.musicly.presentation.components.PlayerInternalNavigationBar
import javax.annotation.concurrent.Immutable
import com.jyotirmoy.musicly.presentation.components.DismissUndoBar
import com.jyotirmoy.musicly.presentation.components.NavBarContentHeightFullWidth
...
import com.jyotirmoy.musicly.presentation.components.MiniPlayerBottomSpacer
...
import com.jyotirmoy.musicly.presentation.utils.AppHapticsConfig
import com.jyotirmoy.musicly.presentation.utils.LocalAppHapticsConfig
import com.jyotirmoy.musicly.presentation.utils.NoOpHapticFeedback
import com.jyotirmoy.musicly.utils.CrashLogData
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Preload Maintainer Avatar
        val imageLoader = coil.ImageLoader(this)
        val request = coil.request.ImageRequest.Builder(this)
            .data("https://avatars.githubusercontent.com/u/183180575?v=4")
            .build()
    ...
    companion object {
        const val ACTION_SHUFFLE_ALL = "com.jyotirmoy.musicly.ACTION_SHUFFLE_ALL"
        const val ACTION_OPEN_PLAYLIST = "com.jyotirmoy.musicly.ACTION_OPEN_PLAYLIST"
    ...
    private fun MainUI(playerViewModel: PlayerViewModel, navController: NavHostController) {
        ...
        val commonNavItems = remember {
            persistentListOf(
                ...
                BottomNavItem("Explore", R.drawable.rounded_explore_24, R.drawable.rounded_explore_24_filled, Screen.Explore),
